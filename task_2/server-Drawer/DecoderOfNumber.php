...
class Decoder{
    ...
    public function getParameters(int $inputNumber): array
    {
        ...
        $blueSaturation = $this->getParameter($inputNumber, self::BLUE_COLOR_MASK);
        $greenSaturation = $this->getParameter($inputNumber, self::GREEN_COLOR_MASK);
        $redSaturation = $this->getParameter($inputNumber, self::RED_COLOR_MASK);
        return [
            "shape" => $shape,
            "height" => $height,
            "width" => $width,
...
print_r($person->getParameters(1453));